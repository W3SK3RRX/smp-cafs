...
from . import views
from .views import deletar_setor, deletar_funcionario, editar_setor, editar_funcionario, ordem_servico, editar_ordem_servico, download_os_pdf, deletar_os, download_admin_pdf
...
urlpatterns = [
    ...
    # Download PDF da área administrativa
    path('area_administrativa/download/', download_admin_pdf, name="download_admin_pdf"),
]
